...
$(document).ready(function() {
    ...
    //正浮点数
    jQuery.validator.addMethod("xsIsInteger", function(value, element) {
        //alert("value="+ value + "，element="+ element.id);
        return this.optional(element)
        ||/^(\d*|\-?[1-9]{1}\d*)$/.test(value);
    }, "<font color=red>&nbsp;学时请输入正整数！&nbsp;</font>");
    jQuery.validator.addMethod("xfIsFloat", function(value, element) {
        //alert("value="+ value + "，element="+ element.id);
        return this.optional(element)
        || /^(([0-9]+\.[0-9]*[1-9][0-9]*)|([0-9]*[1-9][0-9]*\.[0-9]+)|([0-9]*[1-9][0-9]*))$/.test(value);
    }, "<font color=red>&nbsp;学分请输入正浮点数！&nbsp;</font>");
    //分数校验0-100数字
     jQuery.validator.addMethod("cjValidate", function(value, element) {
        //alert("value="+ value + "，element="+ element.id);
        return this.optional(element)
        || /^[0-9]{1,2}$/.test(value);
    }, "<font color=red>&nbsp;成绩请输入0-100数字&nbsp;</font>");
    //日期比较
