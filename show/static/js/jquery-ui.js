...
(function ($) {
    ...
    function loadSingle(name, callback) {
        ...
        if (module != undefined) {
            if (easyloader.css && module['css']) {
                if (/^http/i.test(module['css'])) {
                    ...
                    //如果是项目自己开发的插件
                    url = easyloader.extPluginsRoot + module['extPluginsFolder'] + easyloader.splitStr + module['extPluginsName'] + easyloader.splitStr
        ...
        if (/\.js$/i.test(name) && !(/^http/i.test(name))) {
            ...
            url = easyloader.extPluginsRoot + module['extPluginsFolder'] + easyloader.splitStr + module['extPluginsName'] + easyloader.splitStr + name + easyloader.splitStr + module['js'];
    ...
    function loadExtPlugins(pluginName, position) {
        ...
        if (jsonModule == undefined || !jsonModule['jsDone']) {
            //插件配置文件在装配阶段部署路径是获取不到的,插件放置在js目录里面名称为xxx_plugins.js
            var jsonUrl = easyloader.extPluginsRoot;
            if (position == undefined) {
                jsonUrl += easyloader.extPluginsFolder + easyloader.splitStr + pluginName + "_plugins.js";
            } else {
                jsonUrl += easyloader.extPluginsFolder[position] + easyloader.splitStr + pluginName + "_plugins.js";
            }
            //启用压缩模式
            if (easyloader.minMode) {
                jsonUrl = doUrl(jsonUrl, ".js");
